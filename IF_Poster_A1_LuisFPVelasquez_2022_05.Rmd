...
main_textsize: "135px"
main_picwidth: "100%"
main_findings: " <font color='#ffffff'>Advancement in</font> <font color='#ffbc00'>hydrology as a data-intensive science</font> <font color='#ffffff'>needs to explore effective approaches for the use and analysis of the petabytes of existing </font><font color='#ffbc00'>Earth Observation data.</font>  <br><br>"
logoright_name: "![](Figures/cdt_banner_trans_A1.png)"
# Body Section
body_bgcol: "#ffffff"
body_textsize: "30px"
...
body_textcol: "#000000"
title_textsize: "55pt"
author_textsize: "1.115em"
authorextra_textsize: "28px"
...
# Context
Given the current and projected pressures over regional and global water systems as a result of population growth and human activities, water security has been recognised as one of the most significant challenges of the 21st century (@srinivasan2017dynamic). Therefore, rigorous quantification of the impacts of climate change on water security have a key role informing water management and policy, and to support the progress in the implementation of the Sustainable Development Goals (SDGs) (@eekhout2018increased). 
...
This research will be at the junction of three areas: Physically-based hydrological modelling, satellite Earth observation data and cloud computing technology. During the past
